...
<section
  ...
  x-data="
      ...
      "
  class="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] bg-gray-100 dark:bg-gray-900 "
>
  <div class="container">
    <div class="flex flex-wrap -mx-4">
      <div class="w-full px-4">
        <div class="text-center mx-auto mb-[60px] max-w-[800px]">
          <h2 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-dark dark:text-gray-300 mb-4">
            Ma formation
          </h2>
          <p class="text-base text-body-color">
          La formation TDI vise à préparer des ingénieurs 
          aptes à guider les entreprises dans l'adoption 
          des nouvelles technologies<br/> Voici les modules clés enseignés dans ce programme.
          </p>
        </div>
      </div>
    </div>
...
<!-- ====== Portfolio Section End --><?php /**PATH /var/www/html/resources/views/components/home/ma-formation.blade.php ENDPATH**/ ?>